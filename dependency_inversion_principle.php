 ...
 * but they should depend on abstractions.This principle allows for decoupling.
 ...
 * but according to the definition of D in SOLID, which states to Depend on abstraction, 
 ...
 */
  ...
  */
   ...
   * To address these issues, you can code to an interface since high-level and low-level modules
   ...
   * Also, instead of directly type-hinting MySQLConnection class in the constructor of the PasswordReminder, 
   * you instead type-hint the DBConnectionInterface and no matter the type of database your application uses, 
   * the PasswordReminder class can connect to the database without any problems 
   * and open-close principle is not violated.
   */
